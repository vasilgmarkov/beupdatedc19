<template>
  <v-container class="text-center country" v-if="countryInfo">
  <div><img :src="`https://www.countryflags.io/${countryInfo.countrydata[0].info.code.toLowerCase()}/flat/32.png`"><p>{{countryInfo.countrydata[0].info.title}} has <b>{{countryInfo.countrydata[0].total_cases}}</b> confirmed cases.</p></div>
